...
'''
*
Этот файл отвечает за генерацию клавиатур для расписания
*
'''
...
# Создание клавиатур групп 


FACULTIES_KB = ReplyKeyboardMarkup(resize_keyboard=True)
# Создание клавиатуры факультетов
...
# Списки кнопок для клавиатур групп


FACULTIES_BUTTONS: list = ['ИТ', 'КиИБ', 'РиТ', 'ЦЭиМК', 'СиСС']
# Список кнопок для клавиатуры факультетов
...
# Список кнопок для клавиатуры потоков


DAYS_OF_WEEK_BUTTONS: list = ['сегодня', 'завтра', 'вся неделя']
CURRENT_OR_NEXT_WEEK_BUTTONS: list = ['текущая неделя', 'следующая неделя']
# Список кнопок для клавиатур дня, клавиатуры дня для конфига, недели 


# Заполнение всех клавиатур
DAYS_OF_WEEK_KB.row(
