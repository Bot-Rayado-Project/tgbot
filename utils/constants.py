...
C_SQLITE_FIRST_ADD_CONFIG_BUTTONS: str = 'INSERT INTO config VALUES({0}, "1 ячейка, 2 ячейка, 3 ячейка", False, "first_btn");'  # Вызывается только первый раз для каждого пользователя.
